...
Capturas do build de produção (`next start`), rodando contra o backend real.
Desktop = 1280 px, mobile = 390 px (`@2x`).

| Tela | Arquivos | Etapa |
|---|---|---|
| Login | `login-desktop.png` / `login-mobile.png` | 3 |
| Cadastro | `cadastro-desktop.png` / `cadastro-mobile.png` | 5 |
